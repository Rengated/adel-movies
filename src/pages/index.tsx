          ...
          <div className="flex items-center justify-between w-full mb-10  max-sm:flex-col">
            ...
            <div>
              <select
                ...
                className="bg-transparent px-4 py-3 border border-white rounded-md text-white font-bold">
              ...
              <input
                ...
                className="bg-transparent px-4 py-3 border border-white rounded-md ml-7 text-white font-bold"
              />
            </div>
          </div>
          {films?.length > 0 ? (
